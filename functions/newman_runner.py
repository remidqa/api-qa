...
def run_collection(postman_collection_id, postman_environment_id, folder_name):
    run = requests.post(
...
def run_newman_and_get_report(postman_collection_id, postman_environment_id, folder_name):
    run = run_collection(postman_collection_id, postman_environment_id, folder_name)
